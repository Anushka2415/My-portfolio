      ...
      <div className="container portfolio__container">
        ...
        <article className='portfolio__item'>
            ...
            <div className="portfolio__item-cta">
              <a href="https://github.com/Anushka2415/Animate-text" target="_blank" rel='noreferrer' className='btn'>Github</a>
            </div>
        ...
        <article className='portfolio__item'>
            ...
            <div className="portfolio__item-cta">
              <a href="https://github.com/Anushka2415/First-project" target="_blank" rel='noreferrer' className='btn'>Github</a>  
            </div>
        ...
        <article className='portfolio__item'>
            ...
            <div className="portfolio__item-cta">
              <a href="https://github.com/Anushka2415" target="_blank" rel='noreferrer' className='btn'>Github</a>
              <a href="https://github.com/Anushka2415/First-project" target="_blank" rel='noreferrer' className='btn btn-primary'>Visit Website</a>  
            </div>
